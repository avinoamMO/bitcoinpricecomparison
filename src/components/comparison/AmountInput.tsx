...
export function AmountInput({ amount, currency, depositMethod, onAmountChange, onCurrencyChange, onDepositMethodChange }: Props) {
  return (
    <div className="space-y-4">
      <div>
        ...
        <div className="relative">
          ...
          <div className="absolute inset-y-0 right-0 pr-3 flex items-center"><span className="text-sm text-muted-foreground">of Bitcoin</span></div>
        </div>
      </div>
